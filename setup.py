...
setup(name='perroquet',
      ...
      ('share/applications', 'perroquet.desktop.in'),
      ...
      ('share/perroquet/', 'gui_message_dialog.ui'),
      ('share/perroquet/', 'reset.ui'),
      ('share/perroquet/', 'perroquet.ui'),
      ('share/perroquet/', 'properties.ui'),
      ('share/perroquet/', 'settings.ui'),
      ('share/perroquet/', 'exercise_manager.ui'),
      ('share/perroquet/', 'gui_password_dialog.ui'),
      ('share/perroquet/', 'properties_advanced.ui'),

      ('etc/perroquet/', 'config.ini'),
      ('etc/perroquet/', 'sources.conf'),
      ('etc/perroquet/', 'languages_aliases.ini'),
      ('etc/perroquet/', 'languages.list'),
      
      ('share/perroquet/', 'audio_icon.png'),
      ('share/perroquet/', 'perroquet.png'),
